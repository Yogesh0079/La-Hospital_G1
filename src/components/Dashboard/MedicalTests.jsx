...
function FullBodyTest({ testId, userId }) {
    const navigate = useNavigate();
    return (
        <>
            <a href="#" onClick={() => navigate(`/TestResults/${testId}`)}>
            ...
            <div className="report-details">
                ...
                <div className="report-date">{testId}</div>
            </div>
            </a>
        </>
    )
...
function XRayTest({ testId, userId }) {
    const navigate = useNavigate();
    return (
        <>
            <a href="#" onClick={() => navigate(`/TestResults/${testId}`)}>
...
function BloodTest({ testId, userId }) {
    const navigate = useNavigate();
    return (
        <>
        <a href="#" onClick={() => navigate(`/TestResults/${testId}`)}>
